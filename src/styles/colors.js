...
export const gqlColor = '#D54599';
export const dockerColor = '#2496ED';
export const azureColor = '#0089D6';
export const reactColor = '#61DAFB';
export const pythonColor = '#FFD747';
export const awsColor = '#F7A80D';
export const terraformColor = '#6858FF';
export const ansibleColor = '#CC0000';
